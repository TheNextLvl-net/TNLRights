        ...
        if (args.length >= 1) {
            if (args[0].equalsIgnoreCase("add")) {
                if (args.length >= 2) {
                    ...
                    if (arg != null) {
                        Permissions manager = arg.getPermissionManager();
                        if (args.length >= 3) {
                ...
                if (args.length >= 2) {
                    ...
                    if (arg != null) {
                        Permissions manager = arg.getPermissionManager();
                        source.sendMessage("%prefix%§7 Permissions§8(§a" + manager.getPermissions().size() + "§8): §6" + String.join("§8, §6", manager.getPermissions()));
